...
#******************************************************************************
#******************added by bilel to perform streamed frames*****************
class LoadStreamFrames:
    ...
    def __next__(self):
        ...
        self.frame_count += 1
        path = f"Frame {self.frame_count}"  # Create a unique path for each frame
